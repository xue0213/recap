...
- **E01**: `tables/phase2_ofa_baseline_summary.md` and
  `rebuttal/reports/PHASE2_OFA_BASELINE_REPORT.md`
- **E02**: `rebuttal/gate_reports/PHASE2_BASELINE_GATES.md`
- **E03**: `tables/phase2_bc_supplement_summary.md`,
  `rebuttal/gate_reports/PHASE2_BC_SUPPLEMENT_GATES.md`, and
  `rebuttal/reports/PHASE2_BC_BASELINE_SUPPLEMENT_REPORT.md`
- **E04**: `tables/phase2_ofo_12_baseline_summary.md`,
...
- Machine-readable B/C supplement evidence is stored under
  `rebuttal/artifacts/phase2_bc_supplement/analysis/`.
